...
export default function HistoriquePage() {
  ...
  useEffect(() => {
    // Charger les scans depuis localStorage
    setScans(getScans())
    setLoading(false)
  }, [])
            ...
            {filteredScans.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="ghost" size="icon" onClick={() => toggleFavorite(scan)}>
                        <Star
                          className={`h-4 w-4 ${scan.favorite ? "text-yellow-400 fill-yellow-400" : "text-gray-400"}`}
                        />
              ...
              <div className="text-center py-12">
                <p className="text-gray-400">
                  {searchTerm ? "Aucun résultat trouvé" : "Aucun scan dans votre historique"}
                </p>
